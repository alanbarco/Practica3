...
class IncidenteRepository extends ServiceEntityRepository
{
    ...
    public function findEstadoDescripcionIncidente()
    {
        $qb = $this->createQueryBuilder('i')
        ->select('i.idIncidente','i.estadoIncidente','i.solucion', 'Tipoincidente.descripcion as tipoDescripcion')
        ->innerJoin('i.idTipo', 'Tipoincidente');
